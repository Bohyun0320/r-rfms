...
//	console.log('route_loader.init 호출됨.');
  logger.debug('route_loader.init called.');
...
//	console.log('설정에 정의된 라우팅 모듈의 수 : %d', infoLen);
    logger.info('Routing Moudle count : ' + infoLen);
...
//		console.log('라우팅 모듈 [%s]이(가) 설정됨.', curItem.method);
        ...
        logger.debug('Router setted - type : ' + curItem.type + ' -- path : ' + curItem.path + ' -- method : ' + curItem.file + ':' + curItem.method);
	}
